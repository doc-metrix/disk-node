...
(function() {
	...
	var	METRICS = require( './../docs/disk.json' );
	...
	*/
	...
	/**
	* METHOD: mget( filter )
	*	Returns metric documentation. If a metric name is provided as a filter, returns an individual metric's documentation. If no documentation exists, returns `null`. If a regular expression is provided, returns all metric documentation matching the filter. If no argument is provided, returns all metric documentation.
	*
	...
	*/
	...
	/**
	* METHOD: dget( name )
	*	Returns documentation associated with devices. If a device `name` is provided, returns an `object` containing associated metric documentation. If no documentation is associated with a device, returns `null`. If no argument is provided, returns an `object` listing all devices and their associated documentation.
	*
	* @param {String} name - device name
	* @returns {Object|null} documentation or null
	*/
